              ...
              components: [
                {
                  ...
                  content: `<@${user.id}> was removed from the blacklist.`,
                },
              ],
            },
          ],
          ...
          components: [
            {
              ...
              components: [
                {
                  type: MessageComponentTypes.TextDisplay,
                  content: `<@${user.id}> was not found in the blacklist.`,
                },
              ],
            },
          ],
          ...
          components: [
            {
              ...
              components: [
                {
                  type: MessageComponentTypes.TextDisplay,
                  content: `<@${user.id}> is already blacklisted.`,
                },
              ],
            },
          ],
        ...
        components: [
          {
            ...
            components: [
              {
                type: MessageComponentTypes.TextDisplay,
                content: `<@${user.id}> was added to the blacklist successfully!`,
              },
            ],
          },
        ],
